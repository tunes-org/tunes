...
- **Date:** 2026-07-20  
- **Deciders:** Programme lead (founders name controller contact before beta)
...
1. **Controller (pre-incorporation):** Name one primary controller contact publicly (`[CONTROLLER_NAME]` / `[CONTROLLER_EMAIL]` in the legal pack). If purposes and means are jointly determined, document a joint-controller arrangement.  
2. **Entity sequencing:**  
...
- Privacy notice and governance statement must carry real controller placeholders before beta.  
