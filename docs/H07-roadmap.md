...
| 2 | Acoustic spike (PCM, metrics, vs SLM) | `tunes-ios` |
| 3 | Journey alignment + correction UX | `tunes-ios` |
| 4 | Privacy / consent / upload preview | `tunes-ios` (+ `tunes-web` intake) |
| 5 | Pipeline, versioning, exports | `tunes-web` → `tunes` releases |
| 6 | London pilot (dense repeats) | all |
| 7 | Public map (honesty chrome) | `tunes-web` |
| 8 | Limited beta | all |
...
[full roadmap](./machine/04-roadmap.md) · [backlog](./machine/05-github-backlog.md) · [tests](./machine/06-test-strategy.md) · [public map](./H13-public-map.md)
